...
class VisionObjectRecognitionViewController: SecondViewController {
    ...
    func drawVisionRequestResults(_ results: [Any]) {
        ...
        for observation in results where observation is VNRecognizedObjectObservation {
            ...
            if topLabelObservation.identifier == "bottle" {
                shapeLayer.backgroundColor = CGColor(colorSpace: CGColorSpaceCreateDeviceRGB(), components: [0, 1.0, 0, 0.4])
            } else {
                shapeLayer.backgroundColor = CGColor(colorSpace: CGColorSpaceCreateDeviceRGB(), components: [1.0, 0, 0, 0.4])
            }
